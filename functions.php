...
/*	wp_enqueue_script( 'pressedsqueezed-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true ); */
	...
	wp_enqueue_script( 'josefin-slab', 'http://use.edgefonts.net/josefin-slab.js', false, false, false);
...
/* function load_fonts() {
	wp_register_style('josefin-slab', 'http://fonts.googleapis.com/css?family=Josefin+Slab:400,700');
	wp_enqueue_style('josefin-slab');
		
	wp_register_style('merriweather', 'http://fonts.googleapis.com/css?family=Merriweather:400,700');
